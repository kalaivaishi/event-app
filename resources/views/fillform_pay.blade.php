            ...
            <form class="mb-5" id="contactForm" name="contactForm" action="{{url('book_seat')}}" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-5">
                  ...
                  <input type="text" class="form-control" name="name" id="name" value="{{$book_detail->name}}">
                </div>
                <div class="col-md-6 form-group mb-5">
                  <label for="" class="col-form-label">Email *</label>
                  <input type="text" class="form-control" name="email" id="email"  value="{{$book_detail->email}}">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6 form-group mb-5">
                  ...
                  <input type="text" class="form-control" name="phone" id="phone"  value="{{$book_detail->phone}}">
                </div>
                <div class="col-md-6 form-group mb-5">
                  <label for="" class="col-form-label">Id Proof Number *</label>
                  <input type="text" class="form-control" name="proof" id="proof"  value="{{$book_detail->id_proof}}">
                </div>
                <div class="col-md-6 form-group mb-5">
                  <label for="" class="col-form-label">Your Organisation Name</label>
                  <input type="text" class="form-control" name="company" id="company"  value="{{$book_detail->organization_name}}">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12 form-group mb-5">
                  ...
                  <textarea class="form-control" name="message" id="message" cols="30" rows="4"  value="{{$book_detail->message}}"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                 <a href="{{('razorpay-payment')}}/{{$book_detail->email}}"><input type="button" value="Pay Now" class="btn btn-primary rounded-0 py-2 px-4"></a>
