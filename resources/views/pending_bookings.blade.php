                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="card-block">
                                ...
                                <h6 class="card-title text-bold">Pending Booking</h6>
                                ...
                                <table class="datatable table table-stripped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-right">Chair-Number</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="btn btn-rounded bg bg-primary">Not Booked</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-nowrap">
                                            ...
                                            <td class="text-right">
                                                <div>T6(AA1)-T6(AA4)</div>
                                            </td>
                                            <td class="text-center">
                                                <span class="btn btn-rounded bg bg-secondary"> N/A</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-nowrap">
