        ...
        book_page.html">
            ...
            <div class="row">
              <div class="col-md-12 form-group">
                <input type="submit" value="Reset Password" class="btn btn-primary rounded-0 py-2 px-4">
                <span class="submitting"></span>
                <a href="index.html"><input type="button" value="Back To Login" class="btn btn-info rounded-0 py-2 px-4">
                <span class="submitting"></span></a>
              </div>
            </div>
          </form>
        </div>
