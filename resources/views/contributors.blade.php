                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="card-block">
                                ...
                                <h2 class="card-title text-bold">Contributors Details</h2>
                                ...
                                <table class="datatable table table-stripped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>tommybernal@example.com</td>
                                            <td>12414786454545</td>
                                            <td class="text-center">Contributors</td>
                                            <td class="text-center">
                                                <span class="btn btn-rounded bg bg-success">Booked</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-nowrap">
